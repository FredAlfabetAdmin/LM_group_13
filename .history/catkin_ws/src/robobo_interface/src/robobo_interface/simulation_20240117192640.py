...
class SimulationRobobo(IRobobo):
    ...
    def _initialise_handles(self) -> None:
        ...
        data = sim.simxGetObjects(self._connection_id, sim.getObjectHandle((self._connection_id,'/Dummy_Danger',simConst.simx_opmode_blocking)), sim.simx_opmode_blocking)
        print(data)
        for dp in data:
            print(dp)

...
class SimulationRobobo(IRobobo):
    ...
    def _initialise_handles(self) -> None:
        ...
        kids = []
        for i in range(10):
            data = sim.simxGetObjectChild(self._connection_id, handle_dummy, i, sim.simx_opmode_blocking)) # clientID, parentObjectHandle, childIndex, operationMode):
        print(data)
        for dp in data:
            print(dp)
        
        # sim.removeObject(10) # To remove objects
